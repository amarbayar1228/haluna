...
const data = [
  {
    ...
    subTitle: (
      <div className="relative mt-4">
        <div className="text-sm">
          {" "}
          ※ [1∼6] 다음 문법을 사용해서 대화를 완성하십시오. (각 3점).{" "}
        </div>
    ...
    answerStr: "갈래요",
    contentDetail: (
      <div className="relative text-center w-full border border-black mt-4 px-3 py-4 max-md:px-2 text-xs">
    ...
    contents: (
      <div className="flex border border-black mt-4 text-xs">
        <div className="border-r px-4 border-black flex justify-center items-center">
          1.{" "}
        </div>
        <div className="flex flex-col gap-3 px-4 py-3">
          <div className="flex justify-center items-center gap-2">
            <div>
              가: 나나 씨, 오늘 시간 있으면 백화점에 같이...{" "}
              <Input
                placeholder="Нөхөж бичнэ үү!"
                size="small"
                className="max-md:mt-1 w-40"
              />
              .?
            </div>
          </div>
          <div>나: 미안해요. 오늘은 너무 바빠서 못 가요.</div>
        </div>
      </div>
    ),
  ...
  },
  {
    ...
    subTitle: (
      <div className="relative mt-4">
        <div className="text-sm">
          {" "}
          ※ [7∼9] {"<보기>"} 와 같이 틀린 부분을 찾고 바르게 고치십시오. (각
          4점){" "}
        </div>
      </div>
    ),
    ...
    contentDetail: (
      <div className="relative text-center w-full border border-black mt-4 px-3 py-4 max-md:px-2 mb-2 text-xs">
        <div className="flex justify-between w-full px-20 max-md:px-2">
          <div className="flex flex-col gap-1 w-full">
            <div className="flex justify-center">
              감기에 <div className="font-bold px-2 underline">걸리려면</div>{" "}
              약을 먹어야 해요.
            </div>
            <div className="flex justify-center">
              감기에 <div className="font-bold px-2 underline">걸리면</div> 약을
              먹어야 해요.
            </div>
          </div>
        </div>
    ...
    contents: (
      <div className="flex border border-black text-xs">
        ...
        <div className="flex flex-col gap-3 px-4 py-3">
          <div className="flex">
            내일이 친구 <div className="px-2 underline">생일 때문에</div> 선물을
            사야 해요.
          </div>
          <div className="flex flex-col gap-1">
            <div>
    ...
    contents: (
      <div className="flex border border-black text-xs">
        ...
        <div className="flex flex-col gap-3 px-4 py-3">
          <div className="flex">
            어제 학교에서 지갑을{" "}
            <div className="px-2 underline">잊어버렸는데</div> 오늘 찾았어요.
          </div>
          <div className="flex flex-col gap-1">
            <div>
              어제 학교에서...{" "}
  ...
  },
  {
    ...
    question: 10,
    answer: 3,
    answerStr: "저는 샤오민 씨처럼 운동을 잘했으면 좋겠어요",
    subTitle: (
      <div className="relative mt-4">
        <div className="text-sm">
          {" "}
          ※ [10∼12] {"<보기>"} 와 같이 순서에 맞게 문장을 만드십시오. (각 4점).
          (각 4점){" "}
        </div>
      </div>
    ),
    contentDetail: (
      <div className="relative text-center w-full border border-black mt-4 px-3 py-4 max-md:px-2 mb-2 text-xs">
        <div className="flex justify-between w-full px-20 max-md:px-2">
          <div className="flex flex-col gap-1 w-full">
            <div className="flex justify-center">
              나는 / 비빔밥 / 불고기를 / 더 / 좋아해요 / 보다
            </div>
            <div className="flex justify-center underline">
              → 나는 비빔밥보다 불고기를 더 좋아해요 .
            </div>
          </div>
        </div>
        <div className="absolute flex justify-center w-full left-0 -top-3 font-bold text-sm">
  ...
  },
  {
    ...
    question: 12,
    answer: 3,
    answerStr: "이 옷을 좀 더 큰 거로 바꿨으면 좋겠어요",
    contents: (
      <div className="flex border border-black text-xs">
        <div className="border-r px-4 border-black flex justify-center items-center">
          12.{" "}
  ...
  },
  {
    ...
    subTitle: (
      <div className="relative mt-4">
        <div className="text-sm">
          {" "}
          ※ [13~14] 다음을 읽고 ( )에 알맞은 말을 쓰십시오. (각 4점)
        </div>
      </div>
    ),
    contents: (
        ...
        <div className="flex flex-col gap-3 px-4 py-3">
          <div className="leading-6">
            ...
            <Input
              ...
              className="w-32"
            />
            .. ) 더 좋아합 니다. 혼자 여행을 하면 여행 일정을 마음대로 계획할 수
            있고 생각할 수 있는 시간 이 많아서 좋습니다. 그리고 여행 간 곳에서
            새 친구들을 만날 수 있어서 좋습니다.
          </div>
        </div>
      </div>
    ),
  ...
  },
  {
    ...
    contents: (
      <div className="flex border border-black text-xs mt-2">
        ...
        <div className="flex flex-col gap-3 px-4 py-3">
          <div className="leading-6">
            요즘 입맛이 없어서 밥을 잘 못 먹습니다. 보통 때는 괜찮은데 아침에
            일어날 때 조금 어지럽습니다. 부모님이 너무 걱정을 하셔서 내일
            부모님과 함께 병원에 한번( ..
            <Input
              placeholder="Нөхөж бичнэ үү!"
              size="small"
